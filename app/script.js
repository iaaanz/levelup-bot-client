    ...
    const { clientIcon, leagueName } = data;
      ...
      if (clientIcon !== data.iconID) {
        document.getElementById("profileSummonerIcon").src = "http://ddragon.leagueoflegends.com/cdn/" + gameVersion + "/img/profileicon/" + data.iconID + ".png";
			...
			const rankedTier = data.rankedTier || document.getElementById("profileRankedTier").innerHTML || "Not logged in.";
			...
			document.getElementById("profileRankedTier").innerHTML = (rankedTier != "undefined undefined") ? rankedTier : "Unranked";
